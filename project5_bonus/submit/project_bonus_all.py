...
plt.savefig("imgs/fig2_images.png", dpi=300)
...
plt.savefig("imgs/fig0_psnr.png", dpi=300)
...
plt.savefig("imgs/fig1_psnr.png", dpi=300)
...
plt.axis('off')
plt.savefig("imgs/fig4_red.png", dpi=300)
